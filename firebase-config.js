...
//    reaches the editor -- the passcode gate on write.html and inbox.html
//    is what actually keeps casual visitors out of those pages. IMPORTANT:
//    because there's no real login system, "read: if true" on submissions
//    means someone who really dug into the site's code could technically
//    read other people's submitted drafts before you've reviewed them --
//    the inbox page just being unlisted/passcode-gated in the UI is not
//    the same as it being cryptographically private. Fine for a casual
//    personal blog, just worth knowing.)
// ---------------------------------------------------------------
